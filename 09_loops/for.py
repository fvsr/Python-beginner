...
# O mesmo código anterior, mas agora usando funções.
# Aqui é o comando "return" que interrompe o loop, 
# pois ele incorpora o comando "break", que também funciona em Python.
# Aqui "return n" é obrigatório para enviar o valor que a função calculou. 
def main():
    number = get_number()
    meow(number)
